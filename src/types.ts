// Contains definitions for types that are not generated by ts2cpp.
// - primitive types
// - types from the c++ standard library
// - handwritten helper types from "cheerp/jshelper.h"
//
// For the purposes of reordering declarations, these types are assumed to
// always exist.
